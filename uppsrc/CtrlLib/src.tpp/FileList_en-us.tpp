...
[s0;l288;%% Sorts the [%-*@3 list] of files by criterion [%-*@3 kind]. 
[%-*@3 kind] can be one of FILELISTSORT`_NAME, FILELISTSORT`_EXT, 
FILELISTSORT`_TIME, optionally combined with FILELISTSORT`_DESCENDING 
(using operator `|).&]
[s3;%% &]
[s0; ]]